 ...
 */
package com.github.shareme.gwslistviewanimations.library.itemmanipulation.swipedismiss;
...
import com.github.shareme.gwslistviewanimations.library.itemmanipulation.TouchEventHandler;
import com.github.shareme.gwslistviewanimations.library.util.AdapterViewUtil;
 ...
 * Implementations of this class should implement {@link #afterViewFling(View, int)}
...
public abstract class SwipeTouchListener implements View.OnTouchListener, TouchEventHandler {
    ...
    /**
     * The resource id of the {@link View} that may steal touch events from their parents.

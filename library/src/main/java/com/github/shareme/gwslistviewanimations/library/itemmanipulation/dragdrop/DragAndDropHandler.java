 ...
 * <p/>
 * Users of this class must call {@link #onTouchEvent(MotionEvent)}
 * and {@link #dispatchDraw(Canvas)} on the right moments.
...
public class DragAndDropHandler implements TouchEventHandler {
     ...
     *
     * @return the position of the item in the list, or {@link AdapterView#INVALID_POSITION}
